...
public class MusicProvider {
    ...
    private static final String CATALOG_URL1 =
        "http://storage.googleapis.com/automotive-media/music.json";

    private static final String CATALOG_URL2 = "https://launchhack-1311.appspot.com/playlists";
    ...
    private synchronized void retrieveMedia() {
        try {
            if (mCurrentState == State.NON_INITIALIZED) {
                ...
                int slashPos = CATALOG_URL1.lastIndexOf('/');
                String path = CATALOG_URL1.substring(0, slashPos + 1);
                JSONObject jsonObj = fetchJSONFromUrl(CATALOG_URL2);
                if (jsonObj == null) {
                    return;
                }
